...
# creo parametro para varios graficos en una pantalla
...
with(subconjunto,{
  plot(subconjunto$Time,as.numeric(as.character(subconjunto$Global_active_power)),type="l",  xlab="",ylab="Global Active Power")  
  plot(subconjunto$Time,as.numeric(as.character(subconjunto$Voltage)), type="l",xlab="datetime",ylab="Voltage")
  ...
  plot(subconjunto$Time,as.numeric(as.character(subconjunto$Global_reactive_power)),type="l",xlab="datetime",ylab="Global_reactive_power")
})
